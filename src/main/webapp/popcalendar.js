...
//Dentro de el siguiente ciclo se generan los anos, en el caso de que sea introducir fecha de nacimiento restale 30---- i>=(yearNow-30)-----
//CAMBIA el siguiente for por este " for	(i=yearNow; i<=(yearNow+4); i++) { " si quieres que los anos empizen en el actual en adelante		
			for	(i=yearNow-2; i<=(yearNow+4); i++) {		
				sName =	i;
				if (i==yearSelected){
					sName =	"<B>" +	sName +	"</B>"
				}
...
//------------------------------------TERMINAR LA FUNCION EN 0 PARA QUE INICIE EN EL DIA ACTUAL EN LA SIGUIENTE LINEA----------------------------------------------
			...
			ctlNow = ctl
                ...
                //lo puse yo por que marcaba error
