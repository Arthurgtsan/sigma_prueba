...
#qrcode {background: #EFEFEF;position: fixed;top: 24px;left: 24px;border: 1px solid #888888;z-index:900;-webkit-animation: fadeIn 1s; animation: fadeIn 1s;}
 ...
 var options = {
   ...
   var cql='';var cql2='';
    ...
    layers+='INEGI'+reg+':edit_pe,';styles+='pol_rur_ext,';cql+=filterpr;
    layers+='INEGI:locs_puntuales_v,';styles+='locsrur1,';cql+='INCLUDE;';
    layers+='INEGI:locs_puntuales_v,';styles+='locsruret1,';cql+='INCLUDE;';
    // actualizado
    layers+='INEGI'+reg+':cat_manz,';styles+='mza,';cql+=filtermz;
    layers+='INEGI'+reg+':cat_manz,';styles+='mzaetbd,';cql+=filtermz;
    layers+='INEGI'+reg+':cat_cd,';styles+='caserio,';cql+='INCLUDE;';
    layers+='INEGI'+reg+':edit_agebu,';styles+='agebs,';cql+=filterau;;
    layers+='INEGI'+reg+':edit_agebu,';styles+='agebsetbd,';cql+=filterau;
    layers+='INEGI'+reg+':edit_locr,';styles+='porur,';cql+=filterpr;
    layers+='INEGI'+reg+':edit_locr,';styles+='poruretbd,';cql+=filterpr;
...
case 'BI':
    fo=bing;
    fo.opacity=opener.bing.opacity;
    break;
case 'ES':
    fo=esri;
