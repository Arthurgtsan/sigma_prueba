...
out.flush();
      ...
      Connection conexion = DriverManager.getConnection("jdbc:postgresql://10.153.3.21:5433/mgn2k","mgn2k","internet");
      ...
      out.print ("<br><table align=center><tr><td>Procesando cambios en mgn2k remoto...");out.flush();
 ...
 out.print ("<script>window.opener.document.getElementById('real2').innerHTML = 'Ok!';");
