...
function obt_geom(gid,ban){
    var ajax=nuevoAjax();
    ajax.open("GET",'obtgeo_modcar_acu.jsp?id='+gid+'&ban='+ban+'&tipo=2', true);
...
if (filtipo2.equals("X")){
  ...
  select2+=" codigoact='"+filtipo2+"' and ";
}
...
if ((ent.equals("00"))){
         switch(regionalid){
          ...
          case "10":
            ...
            if (filent.equals("00")){
          consulta="select gid,cve_ent,cve_mun,cve_loc,'0' as cve_ageb,'0' as codigoact,f_registro,proc,fresp,case when geom is null then '0' else '1' end as geom,ban,cve_def,status,observ,'0' as figura,cgo_def,'0' as cveoper from act_cu.bcu_bd_pe"+
            " where  "+select1+" "+select2+" f_registro between '"+filfe1+"' and '"+ filfe2 +"' "+filreg+
            " order by cve_ent,cve_mun,cve_loc,gid";
          where = select1+" "+select2+" f_registro between '"+filfe1+"' and '"+ filfe2 +"' "+filreg+" order by cve_ent,cve_mun,cve_loc,gid";
                }else{
          consulta="select gid,cve_ent,cve_mun,cve_loc,'0' as cve_ageb,'0' as codigoact,f_registro,proc,fresp,case when geom is null then '0' else '1' end as geom,ban,cve_def,status,observ,'0' as figura,cgo_def,'0' as cveoper from act_cu.bcu_bd_pe"+
              " where  "+select1+" "+select2+" f_registro between '"+filfe1+"' and '"+ filfe2 +"' and cve_ent = '"+filent+"'"+
            " order by cve_ent,cve_mun,cve_loc,gid";
          where = select1+" "+select2+" f_registro between '"+filfe1+"' and '"+ filfe2 +"' and cve_ent = '"+filent+"' order by cve_ent,cve_mun,cve_loc,gid";
                }
    ...
    consulta="select gid,cve_ent,cve_mun,cve_loc,'0' as cve_ageb,'0' as codigoact,f_registro,proc,fresp,case when geom is null then '0' else '1' end as geom,ban,cve_def,status,observ,'0' as figura,cgo_def,'0' as cveoper from act_cu.bcu_bd_pe"+
      ...
      " order by cve_ent,cve_mun,cve_loc,gid";
    where = select1+" "+select2+" f_registro between '"+filfe1+"' and '"+ filfe2 +"' and cve_ent = '"+ent+"' order by cve_ent,cve_mun,cve_loc,gid";
    select="<select name=filent class='boton'>";
  ...
  if(loc != null && !loc.isEmpty()){
    ...
    consulta="select gid,cve_ent,cve_mun,cve_loc,'0' as cve_ageb,'0' as codigoact,f_registro,proc,fresp,case when geom is null then '0' else '1' end as geom,ban,cve_def,status,observ,'0' as figura,cgo_def,'0' as cveoper from act_cu.bcu_bd_pe"+ " where   cve_ent||cve_mun||cve_loc like '" + loc.replace("-", "") + "%' "+filult+" order by cve_ent,cve_mun,cve_loc,gid";
         where = "cve_ent||cve_mun||cve_loc like'" +  loc.replace("-", "") + "%' "+filult+" order by cve_ent,cve_mun,cve_loc,gid";
}
       ...
       select2+="<option value='7' ";if (filtipo2.equals("7")){select2+="selected";}select2+=">7</option>";
       select2+="<option value='9' ";if (filtipo2.equals("9")){select2+="selected";}select2+=">9</option>";
	   select2+="<option value='81' ";if (filtipo2.equals("81")){select2+="selected";}select2+=">81</option>";
      ...
      out.println( "<center class='t'><b class='t' style='background-color: #E7A4F9;'>&nbsp;&nbsp;Informacion procedente de la AC Integral&nbsp;&nbsp;(POL.EXT.)</b><br><br>"
                + "<input class='boton'  type='button' value=' Manzanas ' onclick='window.open(\"modcar_acu.jsp?loc=&pass="+pass+"\",\"_self\");''>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                + "<input class='boton' disabled type='button' value=' Pol. Externos ' >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                + "<input class='boton' type='button' value=' Localidades ' onclick='window.open(\"modcarloc_acu.jsp?loc=&pass="+pass+"\",\"_self\");''></center>"
                + "<form action=\"modcar_acu_pe.jsp\" method=\"post\" name=\"enviar\">"
                + "<center><br>"
  ...
  out.println("<th>&nbsp;&nbsp;Ver&nbsp;&nbsp;<th>&nbsp;&nbsp;Clave&nbsp;&nbsp;<th colspan=1>&nbsp;Nota&nbsp;<th>Fecha<br>&nbsp;registro&nbsp;<th>Fecha<br>&nbsp;respuesta&nbsp;<th>&nbsp;Procede&nbsp;<th>&nbsp;Respuesta&nbsp;<th title='Registro con informe'>&nbsp;<img src=images/res.png>&nbsp;");
  if (ban!=null){
  //out.println(consulta);
    ...
    //gid,cve_ent,cve_mun,cve_loc,cve_ageb,codigoact,f_registro,proc,fresp,geom,ban,cve_def,status,nota,figura,cgo_def,cveoper 
      ...
      String protxt="";
      String resp="";
                resp="<td align=center nowrap><div>&nbsp;&nbsp;"+cve_def+"&nbsp;&nbsp;</div>";

     switch(proc){
        case "0": 
          protxt="<td align=center nowrap><div id=pr1"+gid+">&nbsp;&nbsp;<b>SIN RESPUESTA</b>&nbsp;&nbsp;</div>";
          //resp="<td align=center nowrap><div id=pr2"+gid+">&nbsp;&nbsp;--&nbsp;&nbsp;</div>";
          break;
        case "1": 
          protxt="<td align=center nowrap><div id=pr1"+gid+">&nbsp;&nbsp;<font color='green'><b>SI PROCEDE</b></font>&nbsp;&nbsp;</div>";
            //resp="<td align=center nowrap><div id=pr2"+gid+">&nbsp;<input type=button onclick='ver_resp(\""+cve_ent+" "+cve_mun+" "+cve_loc+" "+cve_ageb+"\","+gid+");' value=' Respuesta ' class='boton'>&nbsp;</div>";
          //resp="<td align=center nowrap><div id=pr2"+gid+">&nbsp;&nbsp;--&nbsp;&nbsp;</div>";
        ...
        //protxt="<td align=center nowrap><div id=pr1"+gid+cgo+">&nbsp;&nbsp;<a class='liga2' title='Regresar el registro a SIN RESPUESTA'  href='javascript:;' onclick='campro("+gid+",\""+cgo+"\");'><font color='red'><b>NO PROCEDE</b></font></a>&nbsp;&nbsp;</div>";
          protxt="<td align=center nowrap><div id=pr1"+gid+">&nbsp;&nbsp;<b>NO PROCEDE</b>&nbsp;&nbsp;</div>";
          //resp="<td align=center nowrap><div id=pr2"+gid+">&nbsp;&nbsp;--&nbsp;&nbsp;</div>";
          break;
      }
      ...
      if (geom.equals("1")){
        out.println("<td align=center nowrap>&nbsp;<input type=button onclick='obt_geom("+gid+",0);' value=' Ver ' class='boton'>&nbsp;");
      }else{
        out.println("<td align=center nowrap title='Sin geometria'>&nbsp;-&nbsp;");
            ...
            out.println("<td align=left>&nbsp;&nbsp;"+(nota)+"&nbsp;&nbsp;");
...
String barra="";
if(startIndex != 0) {
barra="<a class=liga1 href='modcar_acu_pe.jsp?loc="+loc+"&pass="+pass+"&tipo="+tipo+"&ban="+ban+"&startIndex="+(startIndex-numRecordsPerPage)+"'> &nbsp;<<&nbsp; </a>";
}
...
for (n =0 ; n<numPages; n++){
  if (n*numRecordsPerPage == startIndex) {
    ...
    barra+="<a class=liga1 href='modcar_acu_pe.jsp?filent="+filent+"&filtipo="+filtipo+"&filtipo2="+filtipo2+"&filfe1="+filfe1+"&filfe2="+filfe2+"&loc="+loc+"&pass="+pass+"&tipo="+tipo+"&ban="+ban+"&startIndex="+(numRecordsPerPage*n)+"'> &nbsp;"+(n+1)+"&nbsp; </a>";
  }
 }
...
if(startIndex+numRecordsPerPage <= totalRows){
  barra+="<a class=liga1 href='modcar_acu_pe.jsp?filent="+filent+"&filtipo="+filtipo+"&filtipo2="+filtipo2+"&filfe1="+filfe1+"&filfe2="+filfe2+"&loc="+loc+"&pass="+pass+"&tipo="+tipo+"&ban="+ban+"&startIndex="+(startIndex+numRecordsPerPage)+"'> &nbsp;>>&nbsp; </a>";
}
out.println(barra+"<br><br>");
 String export = consulta.replace("%", "$");
        export = export.replace("'","%2A");
        export = export.replace("|","%7C");
        export = export.substring(0, (export.indexOf("order by cve_ent,cve_mun,cve_loc,gid")+36));
