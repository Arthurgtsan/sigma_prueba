...
function validaenviar(){
		val1=document.captura.new_pas.value;
		val2=document.captura.conf_pas.value;		
...
if(val1!=val2){
  alert("No coincide el nuevo Password con la confirmacion!!");
  return false;
}
...
<form name="captura" action="zedit_act_Sigma.jsp" method="post" >

<%
out.println( "<H2><CENTER CLASS=n ALIGN=CENTER> Actualizar Password de Sigma <br> para el usuario: "+usuario+"</H2>");
out.println("<td>");
out.println("<br>");
out.println("<td>");
out.println("<tr>");
...
out.println("<tr>");
out.println("<td class=n align='center'><b>&nbsp;&nbsp;Nuevo Password de Sigma:&nbsp;&nbsp;</b></td>");
out.println("<td align=center><INPUT type='text' NAME='new_pas' SIZE=20  maxlength=20 class='input' value='' onClick='this.select()'></td>");
out.println("<tr>");
out.println("<td class=n align='center'><b>&nbsp;&nbsp;Confirmar Nuevo Password:&nbsp;&nbsp;</b></td>");
out.println("<td align=center><INPUT type='text' NAME='conf_pas' SIZE=20  maxlength=20 class='input' value='' onClick='this.select()'></td>");
...
out.println("<tr>");
out.println("<td>");
out.println("<input id='prodId' name='prodId' type='hidden' value="+usuario+">");
out.println("<br>");
out.println("<td>");
