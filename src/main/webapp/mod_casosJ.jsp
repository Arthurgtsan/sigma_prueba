...
try {
  if (tipo.equals("1")){
		  consulta = "select m_casos_especialesJ('"+cgo+"','"+cve_ent+"','"+cve_mun+"','"+cve_loc+"','"+cve_ageb+"','"+us+"')";
    }else{
      consulta = "select m_casos_especialescdJ('"+cgo+"','"+cve_ent+"','"+cve_mun+"','"+cve_loc+"','"+cve_ageb+"','"+us+"','"+geom+"')";
  }
