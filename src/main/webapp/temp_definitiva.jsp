...
if(ni.equals("13")){
	...
	out.println ("<input type='radio' id='gender5' name='gender' value='RegNar'  onChange='envia();'><b class=n><font color='#F87006'>Def > Def</font></b>");
	filtro="";
	...
	out.println ("<input type='radio' id='gender3' name='gender' value='manzana' onChange='envia();' ><b class=n>Manzana</b>&nbsp;&nbsp;&nbsp;");
	out.println ("<input type='radio' id='gender4' name='gender' value='caserio' onChange='envia();' ><b class=n>Caserio</b>&nbsp;&nbsp;&nbsp;");
	out.println ("<input type='radio' id='gender5' name='gender' value='RegNar'  onChange='envia();'checked><b class=n><font color='#F87006'>Def > Def</font></b>");
	//filtro=" and (de='C' or de='C-C' or de='C-M' or de='C-L')";
	}
	else{
	out.println ("<input type='radio' id='gender1' name='gender' value='Todo' onChange='envia();' checked><b class=n>Todo</b>&nbsp;&nbsp;&nbsp;");
...
if(filent.equals("00") && ni.equals("13")){
	...
	campos="<table border=1 ><tr onmouseover='this.style.background=#c0c0c0' onmouseout='this.style.background=#F87006' class=n bgcolor=#DBDBD>";
		campos+="<td align=center style='background-color:#dadeda;'><strong>&nbsp;No&nbsp;</strong>";
				campos+="<td align=center style='background-color:#dadeda;'><strong>&nbsp;Operativo&nbsp;</strong>";
		campos+="<td align=center style='background-color:#dadeda;'><strong>&nbsp;Cveoper&nbsp;<br>&nbsp;Censor&nbsp;</strong>";
		campos+="<td align=center style='background-color:#dadeda;'><strong>&nbsp;Cveoper&nbsp;<br>&nbsp;Act&nbsp;</strong>";
		...
		campos+="<td align=center style='background-color:#dadeda;' nowrap><strong>Fecha<br>&nbsp;Provisional&nbsp;</strong>";
		...
		campos+="<td align=center style='background-color:#9ED7EE;' nowrap><strong>&nbsp;De&nbsp;</strong>";
		campos+="<td align=center style='background-color:#9ED7EE;'><strong>&nbsp;Figura&nbsp;</strong>";
		campos+="<td align=center style='background-color:#9ED7EE;'><strong>&nbsp;Status&nbsp;</strong>";
		out.println(campos);
	 ...
	 String color="";
      ...
      rs = str.executeQuery("select *  from temp_def_pob "+consulta+ cadena+ filtro+" order by de desc,cvegeo_prov,cvegeo_def;" );
	  //out.println("select *  from temp_def_pob "+consulta+ cadena+ filtro+" order by de desc,cvegeo_prov,cvegeo_def;" );
String consulta_com="select *  from temp_def_pob "+consulta+ cadena+ filtro+" order by de desc,cvegeo_prov,cvegeo_def;" ;
...
*/
           ...
           // String s4=rs.getObject(5).toString();//cve_mun_prov
			...
			//String s19=rs.getObject(24).toString();//Status
			
			
String s0=rs.getObject("operativo").toString();//cveoper_act
String s25=rs.getObject("cveoper_censor").toString();//cveoper_act            
            String s1=rs.getObject("cveoper_act").toString();//cveoper_act
			String s2=rs.getObject("cvegeo_prov").toString();//fecha_prov
            String s3=rs.getObject("cve_ent_prov").toString();//cve_ent_prov
            String s4=rs.getObject("cve_mun_prov").toString();//cve_mun_prov
            String s5=rs.getObject("cve_loc_prov").toString();//cve_loc_prov
            String s6=rs.getObject("cve_ageb_prov").toString();//cve_ageb_prov
            String s7=rs.getObject("cve_mza_prov").toString();//cve_mza_prov
			String s8=rs.getObject("tipo_prov").toString();//tipo_prov
			String s9=rs.getObject("fecha_prov").toString();//fecha_prov

			String s10=rs.getObject("cvegeo_def").toString();//fecha_prov
			String s11=rs.getObject("cve_ent_def").toString();//cve_ent_def
			String s12=rs.getObject("cve_mun_def").toString();//cve_mun_def
			String s13=rs.getObject("cve_loc_def").toString();//cve_loc_def
			String s14=rs.getObject("cve_ageb_def").toString();//cve_ageb_def
			String s15=rs.getObject("cve_mza_def").toString();//cve_mza_def
			String s16=rs.getObject("tipo_def").toString();//tipo_def
			String s17=rs.getObject("de").toString();//de
			String s18=rs.getObject("Figura").toString();//Figura
			String s19=rs.getObject("Status").toString();//Status
		...
		if(buscar.equals("RegNar")){
			...
			if (((Integer.parseInt(s7)<700 || Integer.parseInt(s15)>899) && s17.substring(0, 1).equals("M")) 
				|| ((Integer.parseInt(s7)!=800 || Integer.parseInt(s15)>899) && s17.substring(0, 1).equals("C"))
  			    || (( Integer.parseInt(s5)<5000) && s17.substring(0, 1).equals("L"))     //-- 5000 es para Economico, 9000 es para poblacion
				|| s16.equals("X")){
			...
			datos+="<td align=center>&nbsp;&nbsp;"+s0+"&nbsp;&nbsp;";
			datos+="<td align=center>&nbsp;&nbsp;"+s25+"&nbsp;&nbsp;";
			...
			datos+="<td align=center nowrap>&nbsp;&nbsp;"+s9+"&nbsp;&nbsp;";
			...
			datos+="<td align=center nowrap>&nbsp;&nbsp;"+s17+"&nbsp;&nbsp;";
			datos+="<td align=center>&nbsp;&nbsp;"+s18+"&nbsp;&nbsp;";
			datos+="<td align=center>&nbsp;&nbsp;"+s19+"&nbsp;&nbsp;";
			out.println(datos);
				count+=1;
			}
		}else{
