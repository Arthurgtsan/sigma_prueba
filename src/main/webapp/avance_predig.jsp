...
// consulta oficial String consulta1 = "select cve_ent,(select count(*) from respaldo_z_digmz where (cve_baja!='BCUU' or cve_baja is null) and cve_ent =t1.cve_ent) as cm, (select count(*) from respaldo_z_digpe where cve_ent =t1.cve_ent) as cf, (select count(*) from respaldo_z_digmp where cve_ent =t1.cve_ent) as ce from cat_ent t1 where status=1 ";
...
// continuacion de la consulta consulta1+= " order by cve_ent";
...
*/
	  ...
	  rs = Constructor_de_Consultas.consulta_avance_predig_01("act10_ed");
