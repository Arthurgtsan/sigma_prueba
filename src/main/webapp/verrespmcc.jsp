...
if (figura.equals("CENSOR")){
  fig="C";
    ...
    consulta= "select cve_ent,cve_mun,cve_loc,cve_ageb,cve_mza,cve_temp,ban,proy,tipomza from cat_manz where vienede='"+fig+gid+"' ";
    //consulta+= " and (cve_ent||cve_mun||cve_loc||cve_ageb||cve_mza in (select clave1 from v_te_mza) ";
    //consulta+= " or cve_ent||cve_mun||cve_loc||cve_ageb||cve_mza in (select clave2 from v_te_mza)) ";
    consulta+= "union select cve_ent,cve_mun,cve_loc,cve_ageb,cve_mza,cve_temp,ban,proy,'9' as tipomza from cat_cd where vienede='"+fig+gid+"' ";
    //consulta+= " and (cve_ent||cve_mun||cve_loc||cve_ageb||cve_mza in (select clave1 from v_te_mza) ";
    //consulta+= " or cve_ent||cve_mun||cve_loc||cve_ageb||cve_mza in (select clave2 from v_te_mza)) ";
