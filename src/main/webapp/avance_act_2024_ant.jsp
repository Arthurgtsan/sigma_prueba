...
*/
	...
	rs = Constructor_de_Consultas.consulta_avance_act_2024_ant_01("act10_ed");
...
out.println("<th colspan=1 rowspan=3 bgcolor=#ffc26c>&nbsp;&nbsp;Actualizaciones&nbsp;<br>&nbsp;integradas<br>&nbsp;MCC-SIGMA&nbsp;&nbsp;");
out.println("<th colspan=1 rowspan=3 bgcolor=#ffd191>&nbsp;&nbsp;Actualizaciones&nbsp;<br>&nbsp;Relacionadas<br>&nbsp;MCC-SIGMA&nbsp;&nbsp;");

out.println("<th colspan=9 bgcolor=#c2f0c2>&nbsp;TABLAS DE EQUIVALENCIA&nbsp;");
...
out.println("<th rowspan=2 bgcolor=#c2f0c2>&nbsp;Cambios&nbsp;de&nbsp;<br>&nbsp;clave&nbsp;");

//out.println("<th rowspan=2 bgcolor=#8299BB>&nbsp;Registros de&nbsp;<br>&nbsp;actualizacion dentro de la&nbsp;<br>&nbsp;cobertura CE&nbsp;");
...
out.println("<th rowspan=2 bgcolor=#ffffff>&nbsp;Cambios&nbsp;<br>&nbsp;de&nbsp;forma&nbsp;");
...
//out.println("<th bgcolor=#8299BB>&nbsp;Aceptada&nbsp;");
//out.println("<th bgcolor=#8299BB>&nbsp;Aceptada&nbsp;<br>&nbsp;con&nbsp;cambios&nbsp;");
//out.println("<th bgcolor=#8299BB>&nbsp;No procede&nbsp;");
//out.println("<th bgcolor=#8299BB>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
//out.println("<th bgcolor=#8299BB>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TCAR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
      String cve_ent;
      String imprimir="";
      int t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,t14,t15,t16,t17,t18,t19,t20,t21;
      int sum1=0;int sum2=0;int sum3=0;int sum4=0;int sum5=0;int sum6=0;int sum7=0;int sum8=0;int sum9=0;int sum10=0;
      int sum11=0;int sum12=0;int sum13=0;int sum14=0;int sum15=0;int sum16=0;int sum17=0;int sum18=0; int sum19=0; int sum20=0; int sum21=0;
...
while(rs.next()){
      if (colorfila==0){
        ...
        t1=Integer.parseInt(rs.getObject(2).toString()); //val1
        t2=Integer.parseInt(rs.getObject(3).toString()); //val2
        t3=Integer.parseInt(rs.getObject(4).toString()); //val3
        t4=Integer.parseInt(rs.getObject(5).toString()); //val4
        t5=Integer.parseInt(rs.getObject(6).toString()); //val5
        t6=Integer.parseInt(rs.getObject(7).toString()); //modcar1
        t7=Integer.parseInt(rs.getObject(8).toString()); //modcar2
        t8=Integer.parseInt(rs.getObject(9).toString()); //modcar3
        t9=Integer.parseInt(rs.getObject(10).toString()); //ensigma
        t10=Integer.parseInt(rs.getObject(11).toString()); //total
        t11=Integer.parseInt(rs.getObject(12).toString()); //columna
        t12=Integer.parseInt(rs.getObject(13).toString()); //valc
		...
		t19=Integer.parseInt(rs.getObject(20).toString()); //cam_cve
		t20=Integer.parseInt(rs.getObject(21).toString()); //modcar1_ce
		t21=Integer.parseInt(rs.getObject(22).toString()); //modcar2_ce
        ...
        imprimir+=("<td>"+cve_ent+"");
        imprimir+=("<td bgcolor='#8299BB'>"+formateador.format(t9)+"");
		
		imprimir+=("<td bgcolor='#ffc26c'>"+formateador.format(t20)+"");
		imprimir+=("<td bgcolor='#ffd191'>"+formateador.format(t21)+"");
        ...
        imprimir+=("<td >"+formateador.format(t18)+"");
		imprimir+=("<td >"+formateador.format(t19)+"");
...
out.println("<td bgcolor='#8299BB'>"+formateador.format(sum9)+"");

out.println("<td bgcolor='#ffc26c'>"+formateador.format(sum20)+"");
out.println("<td bgcolor='#ffd191'>"+formateador.format(sum21)+"");


out.println("<td bgcolor='#9FF781'>"+formateador.format(sum10)+""); //total
...
//str.executeUpdate(consulta9);
	...
	Constructor_de_Consultas.consulta_avance_act_2024_ant_02("act10_ed", request.getRemoteAddr());
