...
<%
out.println( "<center class='t'>Tablas de Equivalencia Provisional Definitiva - CU<br><br>");
...
if(ni.equals("11")){
	out.println( "<form  method=\"post\" name=\"enviar\">");
	consulta= " where (substring(cvegeo_prov,1,2)='"+ent+"' or substring(cvegeo_def,1,2)='"+ent+"')";
...
if(ni.equals("12")){
  ...
  String[] array_estados=new String[tama];
		switch(ent){
			case "01":
				nombre_base="actcargeo1";
				consulta= " where (substring(cvegeo_prov,1,2)='02' or substring(cvegeo_prov,1,2)='03' or substring(cvegeo_prov,1,2)='25' or substring(cvegeo_prov,1,2)='26'";
				consulta+=" or substring(cvegeo_def,1,2)='02' or substring(cvegeo_def,1,2)='03' or substring(cvegeo_def,1,2)='25' or substring(cvegeo_def,1,2)='26')";
				array_estados[0] = "02"; array_estados[1] = "03"; array_estados[2] = "25"; array_estados[3] = "26";

			break;
			case "02":
				nombre_base="actcargeo2";
				consulta= " where (substring(cvegeo_prov,1,2)='10' or substring(cvegeo_prov,1,2)='08' or substring(cvegeo_prov,1,2)='32'";
				consulta+=" or substring(cvegeo_def,1,2)='10' or substring(cvegeo_def,1,2)='08' or substring(cvegeo_def,1,2)='32')";
				array_estados[0] = "08"; array_estados[1] = "10"; array_estados[2] = "32";
			break;
			case "03":
				nombre_base="actcargeo3";
				consulta= " where (substring(cvegeo_prov,1,2)='28' or substring(cvegeo_prov,1,2)='05' or substring(cvegeo_prov,1,2)='19'";
				consulta+=" or substring(cvegeo_def,1,2)='28' or substring(cvegeo_def,1,2)='05' or substring(cvegeo_def,1,2)='19')";
				array_estados[0] = "05"; array_estados[1] = "19"; array_estados[2] = "28";
			break;
			case "04":
				nombre_base="actcargeo4";
				consulta= " where (substring(cvegeo_prov,1,2)='18' or substring(cvegeo_prov,1,2)='16' or substring(cvegeo_prov,1,2)='14' or substring(cvegeo_prov,1,2)='06'";
				consulta+=" or substring(cvegeo_def,1,2)='18' or substring(cvegeo_def,1,2)='16' or substring(cvegeo_def,1,2)='14' or substring(cvegeo_def,1,2)='06')";
				array_estados[0] = "06"; array_estados[1] = "14"; array_estados[2] = "16"; array_estados[3] = "18";
			break;
			case "05":
				nombre_base="actcargeo5";
				consulta= " where (substring(cvegeo_prov,1,2)='11' or substring(cvegeo_prov,1,2)='24' or substring(cvegeo_prov,1,2)='22' or substring(cvegeo_prov,1,2)='01'";
				consulta+=" or substring(cvegeo_def,1,2)='11' or substring(cvegeo_def,1,2)='24' or substring(cvegeo_def,1,2)='22' or substring(cvegeo_def,1,2)='01')";
				array_estados[0] = "01"; array_estados[1] = "11"; array_estados[2] = "22"; array_estados[3] = "24";
			break;
			case "06":
				nombre_base="actcargeo6";
				consulta= " where (substring(cvegeo_prov,1,2)='15' or substring(cvegeo_prov,1,2)='17' or substring(cvegeo_prov,1,2)='12'";
				consulta+=" or substring(cvegeo_def,1,2)='15' or substring(cvegeo_def,1,2)='17' or substring(cvegeo_def,1,2)='12')";
				array_estados[0] = "12";array_estados[1] = "15"; array_estados[2] = "17";
			break;
			case "07":
				nombre_base="actcargeo7";
				consulta= " where (substring(cvegeo_prov,1,2)='30' or substring(cvegeo_prov,1,2)='29' or substring(cvegeo_prov,1,2)='21' or substring(cvegeo_prov,1,2)='13' or substring(cvegeo_prov,1,2)='09'";
				consulta+=" or substring(cvegeo_def,1,2)='30' or substring(cvegeo_def,1,2)='29' or substring(cvegeo_def,1,2)='21' or substring(cvegeo_def,1,2)='13' or substring(cvegeo_def,1,2)='09')";
				array_estados[0] = "09"; array_estados[1] = "13"; array_estados[2] = "21"; array_estados[3] = "29"; array_estados[4] = "30";
			break;
			case "08":
				nombre_base="actcargeo8";
				consulta= " where (substring(cvegeo_prov,1,2)='27' or substring(cvegeo_prov,1,2)='20' or substring(cvegeo_prov,1,2)='07'";
				consulta+=" or substring(cvegeo_def,1,2)='27' or substring(cvegeo_def,1,2)='20' or substring(cvegeo_def,1,2)='07')";
				array_estados[0] = "07"; array_estados[1] = "20"; array_estados[2] = "27";
			break;
			case "09":
				nombre_base="actcargeo9";
				consulta= " where (substring(cvegeo_prov,1,2)='23' or substring(cvegeo_prov,1,2)='31' or substring(cvegeo_prov,1,2)='04'";
				consulta+=" or substring(cvegeo_def,1,2)='23' or substring(cvegeo_def,1,2)='31' or substring(cvegeo_def,1,2)='04')";
		...
		consulta= " where (substring(cvegeo_prov,1,2)='"+filent+"' or substring(cvegeo_def,1,2)='"+filent+"')";
		out.println( "<form  method=\"post\" name=\"enviar\">");
		select="<select name=filent class='boton'  onChange='envia();''>";
		select+="<option value='00' ";if (filent.equals("00")){select+="selected";}select+=">TODAS</option>";
				for (int i=0;i<array_estados.length;i++){
...
if(filent.equals("00") && ni.equals("13")){
	...
	campos="<table border=1 ><tr onmouseover='this.style.background=#c0c0c0' onmouseout='this.style.background=#F87006' class=n bgcolor=#DBDBD>";
		...
		campos+="<td align=center style='background-color:#dadeda;'><strong>&nbsp;gid_prov&nbsp;</strong>";
		//campos+="<td align=center style='background-color:#dadeda;'><strong>&nbsp;identifica_prov&nbsp;</strong>";
		campos+="<td align=center style='background-color:#dadeda;'><strong>&nbsp;cvegeo_prov&nbsp;</strong>";
		campos+="<td align=center style='background-color:#dadeda;'><strong>&nbsp;f_registro_prov&nbsp;</strong>";
		campos+="<td align=center style='background-color:#9ED7EE;'><strong>&nbsp;gid_def&nbsp;</strong>";
		campos+="<td align=center style='background-color:#9ED7EE;'><strong>&nbsp;cvegeo_def&nbsp;</strong>";
		campos+="<td align=center style='background-color:#9ED7EE;'><strong>&nbsp;tipo_def&nbsp;</strong>";
		campos+="<td align=center style='background-color:#9ED7EE;'><strong>&nbsp;fresp&nbsp;</strong>";
	 ...
	 String color="";
	  ...
	  //original-- rs = str.executeQuery("select *  from manz_afect_cu "+consulta+ cadena+ filtro+" order by de desc,cvegeo_prov,cvegeo_def;" );
      rs = str.executeQuery("select *  from manz_afect_cu "+consulta+ filtro+" order by de desc,cvegeo_prov,cvegeo_def;");
	  
	  //original--String consulta_com="select *  from manz_afect_cu "+consulta+ cadena+ filtro+" order by de desc,cvegeo_prov,cvegeo_def;" ;
	  String consulta_com="select *  from manz_afect_cu "+consulta+ filtro+" order by de desc,cvegeo_prov,cvegeo_def;" ;
...
*/
            String s1=rs.getObject(1).toString();//gid_prov
            String s2="";//identifica_prov
            String s3=rs.getObject(3).toString();//cvegeo_prov
            String s4=rs.getObject(4).toString();//f_registro_prov
			
            String s5=rs.getObject(5).toString();//gid_def
            String s6=rs.getObject(6).toString();//cvegeo_def
            String s7=rs.getObject(7).toString();//tipo_def
			String s8=rs.getObject(8).toString();//fresp
			String s9=rs.getObject(9).toString();//de
